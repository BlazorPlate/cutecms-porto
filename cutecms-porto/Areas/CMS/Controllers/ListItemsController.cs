...
namespace cutecms_porto.Areas.CMS.Controllers
{
    ...
    public class ListItemsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Body,Url,Class,Ordinal,File,Thumb,ContentListId")] ListItem listItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Body,Url,Class,Ordinal,File,Thumb,FilePath,ContentListId")] ListItem listItem)
        {
            if (ModelState.IsValid)
            {
                Random rand = new Random();
