...
namespace cutecms_porto.Helpers
{
    public static class CultureHelper
    {
        ...
        /// <summary>
        /// Returns a valid culture name based on "name" parameter. If "name" is not valid, it
        /// returns the default culture "en-US"
        /// </summary>
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            // "en-GB", the function will return closes match that is "en-US" because at least the
        ...
        public static string GetNeutralCulture(string name)
        {
            ...
            return name.Split('-')[0]; // Read first part only. E.g. "en-US", "es"
        }
        #endregion Methods
    }
}